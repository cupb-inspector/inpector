    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#btn1").click(function () {
                ...
                if (email == "") {
                    $('.alert').removeClass('alert-success')
                    $('.alert').html('请输入邮箱').addClass('alert-warning').show().delay(2000).fadeOut();
                    return false;
                } else {
                ...
                if (userAgree != true) {
                    $('.alert').removeClass('alert-success')
                    $('.alert').html('不同意协议无法使用本网站服务').addClass('alert-warning').show().delay(2000).fadeOut();
                    return false;
                }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.resultCode == 200) {
                            ...
                            $('.alert').html('操作成功').addClass('alert-success').show().delay(2000)
                                .fadeOut();
                    ...
                    error: function () {//console.log(data);$('.alert').removeClass('alert-success')
