                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav" id='nky'>
                        ...
                        <li class="nav-item menu-item">
                            <a class="nav-link"  href="index-content" target="myiframe"><i class="menu-icon fa fa-laptop"></i>我的主页</a>
                        </li>

                        <li class="nav-item menu-item">
                            <a class="nav-link"  href="check" target="myiframe"><i class="menu-icon fa fa-bolt"></i>我要抢单</a>
                        </li>
                        ...
                        <li class="nav-item menu-item-has-children">
                            <a class="nav-link" data-toggle="collapse" href="#report" aria-haspopup="true"
                                aria-expanded="false" aria-controls="bill">
                            ...
                            <div class="collapse" id="report">
                                <ul class="nav flex-column sub-menu">
                                    <li><a href="reports-unfinished" target="myiframe">未完成</a></li>
                                    <li><a href="reports-finished" target="myiframe">已完成</a></li>
                                    <li><a href="reports-examining" target="myiframe">待审核</a></li>
                               </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item menu-item-has-children">
                            <a class="nav-link" data-toggle="collapse" href="#user" aria-haspopup="true"
                                aria-expanded="false" aria-controls="bill">
                            ...
                            <div class="collapse" id="user">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li><a href="integral" target="myiframe">我的积分</a></li>
                        ...
                        <li class="nav-item menu-item">
                            <a class="nav-link"  href="complaint" target="myiframe"><i class="menu-icon fa fa-edit"></i>我的评价</a>
                        </li>

                        <li class="nav-item menu-item">
                            <a class="nav-link"  href="mynews" target="myiframe"><i class="menu-icon fa fa-bolt"></i>我的消息</a>
                        </li>

                        <li class="nav-item menu-item">
                            <a class="nav-link"  href="index-content" target="myiframe"><i class="menu-icon fa fa-laptop"></i>业务推荐</a>
                        </li>

                        <li class="nav-item menu-item">
                            <a class="nav-link"  href="partner" target="myiframe"><i class="menu-icon fa fa-bolt"></i>我的伙伴</a>
                        </li>
       ...
       <!--content-->
        <div class="content" style="width:100%;height:100%;padding: 0px;background:#f1f2f7">
            <div style="width:100%;height:100%">
                    <iframe name="myiframe" src="index-content"
                    frameborder="no" scrolling="auto" style="height: 100%; width: 100%;"
