                            ...
                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                            ...
                                            <div class="card-text text-sm-center">
                                                <form action="#" method="post" enctype="multipart/form-data"
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col col-md-3"><label for="password-input2"
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col col-md-3"><label for="password-input3"
                                ...
                                <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                    ...
                                    <form action="#" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="password-input4"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="password-input5"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="password-input6"
