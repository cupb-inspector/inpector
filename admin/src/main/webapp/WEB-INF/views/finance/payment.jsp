                        ...
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <c:forEach items="${list}" var="account" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        <img style="width:150px;height:100px" src="image/${account.fileUuid}"
                                             alt="上海鲜花港 - 郁金香" onclick="lookimg(this.src)"/>
                                    </td>
                                    <td>${account.value}</td>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${account.status==0}">
                                                <button type="button" onclick="verifyReport2(this,${account.id},'conform')"
                                                        class="btn btn-success btn-sm">通过
                                                </button>
                                                <button type="button" onclick="verifyReport2(this,${account.id},'cancel')"
