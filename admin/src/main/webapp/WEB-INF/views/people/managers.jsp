                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <div class="stat-digit">${list.size()}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-stats order-table ov-h">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <c:forEach items="${list}" var="order" varStatus="status">
                                <tr>
                                    <td>${order.adminTel }</td>
                                    <td>${order.adminName }</td>
                                    <td>${order.adminEmail }</td>
                                    <td>${order.role}</td>
                                    <td>${order.adminDate}</td>
                                    <td><a href="details3?id=${ order.adminId }">详情</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
            ...
            <div class="card-body">
                <div action="register-user" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="name" class=" form-control-label">姓名</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="name" name="username" placeholder="name"
                                                            class="form-control"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="tel" class=" form-control-label">账号</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="tel" name="account" placeholder="account"
                                                            class="form-control"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="passwd" class=" form-control-label">密码</label></div>
                        <div class="col-12 col-md-9"><input type="password" name='passwd' id="passwd"
                                                            class="form-control" placeholder="password" value="111111">
                            <small class="form-text text-muted">密码初始值为6个1</small>
                        </div>
                    </div>
                    <div class="row form-group">
...
<script>
    ...
    $(document).ready(function () {
        $("#submitbtn1").click(function () {
            ...
            $.ajax({
                //几个参数需要注意一下
                url: getRootPath() + "/register-user",//url
                type: "POST",//方法类型
